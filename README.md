...
ffmpeg -i input.mp4 col_high_%04d.png
...
ffmpeg -i col_high_%04d.png -s 480x270 col_high_%04d.png
...
最初の-framerate 30fpsの連番画像
二つ目の-framerate 60fpsで動画化
-vframes <number>
